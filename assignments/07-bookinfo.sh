...
mkdir ~/book-info-service
git clone -b dev git@github.com:newbeerpongsakorn/itkmitl-bookinfo-ratings.git ~/book-info-service/ratings
git clone -b dev git@github.com:newbeerpongsakorn/itkmitl-bookinfo-details.git ~/book-info-service/details
git clone -b dev git@github.com:newbeerpongsakorn/itkmitl-bookinfo-reviews.git ~/book-info-service/reviews
git clone -b dev git@github.com:newbeerpongsakorn/itkmitl-bookinfo-productpage.git ~/book-info-service/productpage

cd ~/book-info-service/ratings
